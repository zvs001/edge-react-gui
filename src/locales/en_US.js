...
const strings = {
  ...
  edge_description: 'This application would like to create or access its wallet in your Bluecoin account.\n\n It will not have access to any other wallets.',
  ...
  fragment_wallets_seed_share_title: 'Bluecoin Wallet (%s) Seed',
  ...
  request_share_edge_request: 'Share Bluecoin Request',
  ...
  send_scan_header_text: 'Scan, to Send, import, or Bluecoin Login',
  send_to_title: 'To:',
  ...
  string_first_ethereum_wallet_name: 'My Bluecoins',
  ...
  title_edge_login: 'Bluecoin Login',
